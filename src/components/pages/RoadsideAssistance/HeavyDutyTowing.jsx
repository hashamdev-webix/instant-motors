...
import { 
  FaTruck, FaCheckCircle, FaArrowRight, FaPhoneAlt,
  FaHeadset, FaShieldAlt, FaUsers, FaTachometerAlt,
  FaClock, FaBuilding, FaIndustry, FaTools,
  FaWrench, FaRoad
} from 'react-icons/fa';

const HeavyDutyTowing = () => {
  const features = [
    { icon: <FaTruck className="text-xl md:text-2xl" />, title: 'Up to 50 Tons', desc: 'Heavy capacity towing' },
  ...
  const vehicles = [
    { name: 'Commercial Trucks', icon: <FaTruck className="text-3xl md:text-4xl" /> },
    { name: 'Buses', icon: <FaBuilding className="text-3xl md:text-4xl" /> },
    { name: 'Construction Equipment', icon: <FaTools className="text-3xl md:text-4xl" /> },
    { name: 'Industrial Machinery', icon: <FaIndustry className="text-3xl md:text-4xl" /> },
  ];
          ...
          <div className="max-w-3xl">
            ...
            >
              <span className="inline-flex items-center gap-2 bg-blue-500/20 backdrop-blur-md border border-blue-400/30 rounded-full px-3 md:px-4 py-1.5 md:py-2 mb-4 md:mb-6">
                ...
                <span className="text-white text-xs md:text-sm font-medium">Heavy Duty Towing</span>
              </span>
              ...
              <p className="text-white/90 text-sm sm:text-base md:text-lg mt-3 md:mt-4 max-w-2xl">
                Professional heavy duty towing for commercial vehicles, 
                buses, construction equipment, and industrial machinery.
              </p>
      ...
      <section className="relative py-10 md:py-14 overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-3xl mx-auto text-center text-white">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold">Need Heavy Duty Towing?</h2>
            <p className="text-white/80 mt-2 md:mt-3 text-sm sm:text-base">
              Contact us for professional heavy duty towing services.
            </p>
