...
import { 
  FaBuilding, FaCheckCircle, FaArrowRight, FaPhoneAlt,
  FaHeadset, FaShieldAlt, FaUsers, FaClock,
  FaGavel, FaFileInvoice, FaHandshake, FaParking,
  FaCar, FaTruck, FaMotorcycle
} from 'react-icons/fa';

const ImpoundTowing = () => {
  const features = [
    { icon: <FaBuilding className="text-xl md:text-2xl" />, title: 'Property Owners', desc: 'Commercial & residential' },
    ...
    { icon: <FaGavel className="text-xl md:text-2xl" />, title: 'Legal Compliance', desc: 'Proper documentation' },
  ];

  const properties = [
    { name: 'Commercial Complexes', icon: <FaBuilding className="text-3xl md:text-4xl" /> },
    { name: 'Residential Buildings', icon: <FaParking className="text-3xl md:text-4xl" /> },
    { name: 'Shopping Centers', icon: <FaHandshake className="text-3xl md:text-4xl" /> },
    { name: 'Office Buildings', icon: <FaFileInvoice className="text-3xl md:text-4xl" /> },
  ];
          ...
          <div className="max-w-3xl">
            ...
            >
              <span className="inline-flex items-center gap-2 bg-sky-500/20 backdrop-blur-md border border-sky-400/30 rounded-full px-3 md:px-4 py-1.5 md:py-2 mb-4 md:mb-6">
                <FaBuilding className="text-sky-300 text-sm md:text-base" />
                <span className="text-white text-xs md:text-sm font-medium">Private Property Impound</span>
              </span>
              ...
              <p className="text-white/90 text-sm sm:text-base md:text-lg mt-3 md:mt-4 max-w-2xl">
                Professional impound towing for property owners and managers. 
                Legal, compliant, and efficient vehicle removal.
              </p>
        ...
        <div className="container-custom">
          <div className="text-center mb-8 md:mb-12">
            <span className="inline-block px-3 md:px-4 py-1 bg-sky-100 text-sky-700 rounded-full text-xs md:text-sm font-medium mb-3 md:mb-4">
              ...
              We Serve All Properties
            </span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">
              We Serve <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-500 to-sky-300">All Properties</span>
            </h2>
          </div>
            ...
            {properties.map((property, index) => (
              ...
              >
                <div className="w-16 h-16 bg-sky-50 rounded-full flex items-center justify-center mx-auto mb-2 md:mb-3 group-hover:bg-sky-100 transition-colors">
                  <span className="text-sky-500">{property.icon}</span>
                </div>
      ...
      <section className="relative py-10 md:py-14 overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-3xl mx-auto text-center text-white">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold">Need Impound Towing?</h2>
